        ...
        private static readonly Dictionary<string, Dictionary<string, string>> LocalizationData =
            new Dictionary<string, Dictionary<string, string>>(StringComparer.OrdinalIgnoreCase)
            {
                ["de"] = new Dictionary<string, string>
                {
                    ...
                    ["Loc.MsgUpdateAvailable"] = "Version {0} ist verfuegbar (installiert: {1}). Release-Seite jetzt oeffnen?",
                    ["Loc.MsgUpdateAvailableActions"] = "Version {0} ist verfuegbar (installiert: {1}).\n\nJa: Release-Seite oeffnen\nNein: Direkt silent installieren\nAbbrechen: Nichts tun",
                    ["Loc.UpdateDialogTitle"] = "Update verfuegbar",
                    ["Loc.UpdateDialogInstalledLabel"] = "Installiert",
                    ["Loc.UpdateDialogLatestLabel"] = "Neu verfuegbar",
                    ["Loc.UpdateDialogChooseAction"] = "Aktion auswaehlen",
                    ["Loc.UpdateDialogOpenReleaseButton"] = "Release-Seite oeffnen",
                    ["Loc.UpdateDialogInstallNowButton"] = "Jetzt installieren",
                    ["Loc.UpdateDialogLaterButton"] = "Spaeter",
                    ...
                    ["Loc.MsgUpdateNoInstallerAsset"] = "Fuer diese Version wurde kein Installer-Asset gefunden.",
                    ["Loc.MsgUpdateDownloadFailedForInstall"] = "Installer konnte nicht heruntergeladen werden. Bitte spaeter erneut versuchen.",
                    ["Loc.MsgUpdateInstallStarting"] = "Silent-Installation fuer Version {0} wird gestartet.\nDesktopPlus wird jetzt beendet und nach dem Update automatisch neu gestartet.",
