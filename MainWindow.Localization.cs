    ...
    public partial class MainWindow : Window
    {
        private static readonly Dictionary<string, Dictionary<string, string>> LocalizationData =
            new Dictionary<string, Dictionary<string, string>>(StringComparer.OrdinalIgnoreCase)
            {
                ["de"] = new Dictionary<string, string>
                {
                    ...
                    ["Loc.BackupsTitle"] = "Backups verwalten",
                    ["Loc.BackupsDesc"] = "Automatische Sicherungen schützen den Zustand vor Auto-Sort, Updates und kritischen Änderungen. Manuelle Backups können jederzeit erstellt, wiederhergestellt und gelöscht werden.",
                    ["Loc.BackupsCreate"] = "Backup erstellen",
                    ["Loc.BackupsRefresh"] = "Aktualisieren",
                    ["Loc.BackupsOpenFolder"] = "Backup-Ordner öffnen",
                    ["Loc.BackupsEmpty"] = "Noch keine Backups vorhanden.",
                    ["Loc.BackupsNoSelection"] = "Wähle ein Backup aus, um Inhalt und Wiederherstellungsgrund anzuzeigen.",
                    ["Loc.BackupsCount"] = "{0} Backups",
                    ["Loc.BackupsTypeLabel"] = "Typ",
                    ["Loc.BackupsReasonLabel"] = "Grund",
                    ["Loc.BackupsTypeManual"] = "Manuell",
                    ["Loc.BackupsTypeAutoSort"] = "Vor Auto-Sort",
                    ["Loc.BackupsTypeCritical"] = "Sicherheits-Backup",
                    ["Loc.BackupsTypeUpdate"] = "Vor Update",
                    ["Loc.BackupsRestore"] = "Wiederherstellen",
                    ["Loc.BackupsDelete"] = "Löschen",
                    ["Loc.BackupsCreating"] = "Backup wird erstellt...",
                    ["Loc.BackupsCreated"] = "Backup wurde erstellt.",
                    ["Loc.BackupsCreateFailed"] = "Backup konnte nicht erstellt werden: {0}",
                    ["Loc.BackupsDeleted"] = "Backup wurde gelöscht.",
                    ["Loc.BackupsDeleteFailed"] = "Backup konnte nicht gelöscht werden: {0}",
                    ["Loc.BackupsDeleteTitle"] = "Backup löschen",
                    ["Loc.BackupsDeleteConfirm"] = "Soll das Backup \"{0}\" dauerhaft gelöscht werden?",
                    ["Loc.BackupsContainsDesktop"] = "Betroffene Desktop-Dateien und Ordner",
                    ["Loc.BackupsReasonManual"] = "Manuell vom Benutzer erstellt",
                    ["Loc.BackupsNameManual"] = "Manuelles Backup",
                    ["Loc.BackupsReasonAutoSort"] = "Automatisch vor dem Verschieben von Desktop-Elementen",
                    ["Loc.BackupsNameBeforeAutoSort"] = "Zustand vor Auto-Sort",
                    ["Loc.BackupsReasonBeforeRestore"] = "Sicherheitskopie vor einer Wiederherstellung",
                    ["Loc.BackupsNameBeforeRestore"] = "Zustand vor Wiederherstellung",
                    ["Loc.BackupsReasonBeforeLayout"] = "Sicherheitskopie vor dem Anwenden eines Layouts",
                    ["Loc.BackupsReasonBeforeLayoutUpdate"] = "Sicherheitskopie vor dem Überschreiben eines Layouts",
                    ["Loc.BackupsReasonBeforePanelDelete"] = "Sicherheitskopie vor dem Löschen eines Panels",
                    ["Loc.BackupsReasonBeforeLayoutDelete"] = "Sicherheitskopie vor dem Löschen eines Layouts",
                    ["Loc.BackupsReasonBeforeRulesReset"] = "Sicherheitskopie vor dem Zurücksetzen der Auto-Sort-Regeln",
                    ["Loc.BackupsReasonBeforePresetDelete"] = "Sicherheitskopie vor dem Löschen eines Theme-Presets",
                    ["Loc.BackupsReasonBeforePresetReset"] = "Sicherheitskopie vor dem Zurücksetzen der Standard-Presets",
                    ["Loc.BackupsSafetyFailed"] = "Das Sicherheits-Backup konnte nicht erstellt werden. Die Aktion wurde abgebrochen.\n\n{0}",
                    ["Loc.AutoSortMsgBackupFailed"] = "Auto-Sort wurde abgebrochen, weil das Sicherheits-Backup nicht erstellt werden konnte:\n{0}",
                    ...
                    ["Loc.ThemesSection"] = "Bereich",
                    ["Loc.ThemesSectionHeader"] = "Header",
                    ["Loc.ThemesSectionBody"] = "Body",
                    ["Loc.ThemesSectionTabs"] = "Tabs",
                    ...
                    ["Loc.ShortcutsNotifyConflict"] = "Bei Shortcut-Konflikt benachrichtigen",
                    ["Loc.ShortcutsPriorityAbove"] = "Shortcut über dem blockierenden Programm erzwingen",
                    ["Loc.ShortcutsPriorityHint"] = "Aktiviert einen globalen Tastatur-Hook, damit DesktopPlus die Kombination auch dann erhält, wenn ein anderes Programm sie belegt. Ohne Häkchen gibt DesktopPlus dem anderen Programm nach.",
                    ["Loc.ShortcutConflictTitle"] = "Shortcut-Konflikt",
                    ["Loc.ShortcutConflictBodyBelow"] = "Der Hotkey \"{0}\" wird von einem anderen Programm belegt und ist derzeit inaktiv.",
                    ["Loc.ShortcutConflictBodyAbove"] = "Der Hotkey \"{0}\" wird von einem anderen Programm belegt – DesktopPlus hat Vorrang übernommen.",
                    ...
                    ["Loc.ShortcutsRegisterWarning"] = "Hotkey konnte nicht registriert werden: {0}. Eventuell wird er bereits von einer anderen App verwendet – bitte eine andere Kombination wählen und auf Anwenden klicken.",
                    ["Loc.TabCompanion"] = "Companion",
                    ["Loc.CompanionTitle"] = "Handy-Companion",
                    ["Loc.CompanionDesc"] = "Greife vom Handy aus auf deine Panels und Dateien zu – ideal, während am PC ein Vollbild-Spiel läuft. Verbindung nur im selben WLAN, verschlüsselt per HTTPS.",
                    ["Loc.CompanionEnable"] = "Companion-Server aktivieren",
                    ["Loc.CompanionStatusDisabled"] = "Companion ist deaktiviert.",
                    ["Loc.CompanionStatusRunning"] = "Aktiv. Scanne den QR-Code mit dem Handy im selben WLAN.",
                    ["Loc.CompanionStatusError"] = "Server läuft nicht. Eventuell ist der Port belegt – siehe Meldung.",
                    ["Loc.CompanionScanHint"] = "QR-Code mit der Handy-Kamera scannen, dann im Browser die Zertifikatswarnung einmalig bestätigen (selbstsigniert).",
                    ["Loc.CompanionUrlLabel"] = "Adresse",
                    ["Loc.CompanionCopyUrl"] = "Link kopieren",
                    ["Loc.CompanionRegenerate"] = "Token neu generieren",
                    ["Loc.CompanionSecurityNote"] = "Nur im vertrauten Heimnetz nutzen. Der Token ist der Schlüssel zu deinen Dateien – nicht weitergeben und nicht ins Internet freigeben/portforwarden. „Token neu generieren“ trennt bestehende Handy-Verbindungen.",
                    ["Loc.CompanionStartFailed"] = "Companion-Server konnte nicht gestartet werden: {0}",
                    ...
                    ["Loc.PanelTypeRecycleBin"] = "Papierkorb",
                    ...
                    ["Loc.PanelNavigateUpTooltip"] = "Zum übergeordneten Ordner",
                    ["Loc.PanelSearchPlaceholder"] = "Suchen...",
                    ["Loc.PanelSearchShowTooltip"] = "Suche öffnen",
                    ...
                    ["Loc.PanelSettingsShowBackButton"] = "Backbutton anzeigen",
                    ["Loc.PanelSettingsBackNavigation"] = "Rücknavigation",
                    ["Loc.PanelSettingsBackNavigationHeader"] = "Backbutton oben",
                    ["Loc.PanelSettingsBackNavigationParentItem"] = "Überordner als Eintrag",
                    ["Loc.PanelSettingsBackNavigationNone"] = "Keine Rücknavigation",
                    ...
                    ["Loc.PanelSettingsShowCloseButton"] = "Schließen-Button anzeigen",
                    ["Loc.PanelSettingsShowEmptyRecycleBin"] = "Ordner-leeren-Button anzeigen",
                    ["Loc.EmptyRecycleBinButton"] = "Leeren",
                    ["Loc.EmptyRecycleBinTitle"] = "Papierkorb leeren",
                    ["Loc.EmptyRecycleBinConfirm"] = "Möchten Sie den Papierkorb wirklich endgültig leeren? Dieser Vorgang kann nicht rückgängig gemacht werden.",
                    ["Loc.EmptyFolderTitle"] = "Ordner leeren",
                    ["Loc.EmptyFolderConfirm"] = "Möchten Sie den Ordner \"{0}\" wirklich leeren? Alle Inhalte werden in den Papierkorb verschoben.",
                    ...
                    ["Loc.PanelSettingsColumns"] = "Detailspalten",
                    ["Loc.PanelSettingsColumnsHint"] = "Sichtbare Spalten und Zusatzmetadaten wählen.",
                    ["Loc.PanelSettingsChooseColumns"] = "Spalten auswählen",
                    ["Loc.PanelSettingsMetaAuthors"] = "Autoren",
                    ["Loc.PanelSettingsMetaCategories"] = "Kategorien",
                    ["Loc.PanelSettingsMetaTags"] = "Markierungen",
                    ["Loc.PanelSettingsMetaTitle"] = "Titel",
                    ["Loc.DetailColumnName"] = "Name",
                    ["Loc.DetailColumnsDialogTitle"] = "Detailspalten auswählen",
                    ["Loc.DetailColumnsDialogHint"] = "Ein- oder ausblenden, welche Spalten in der Listenansicht sichtbar sind.",
                    ["Loc.DetailColumnsAutoFitColumn"] = "Größe der Spalte anpassen",
                    ["Loc.DetailColumnsAutoFitAll"] = "Größe aller Spalten anpassen",
                    ["Loc.DetailColumnsMore"] = "Weitere...",
                    ["Loc.Cancel"] = "Abbrechen",
                    ["Loc.Apply"] = "Übernehmen",
                    ["Loc.PanelSettingsMovement"] = "Bewegung",
                    ["Loc.PanelSettingsSearchVisibility"] = "Suche",
                    ["Loc.PanelSettingsSearchAlways"] = "Suchfeld",
                    ["Loc.PanelSettingsSearchButtonOnly"] = "Suchbutton",
                    ["Loc.PanelSettingsSearchExpandedOnly"] = "Nur aufgeklappt",
                    ["Loc.PanelSettingsSearchHidden"] = "Ausblenden",
                    ["Loc.PanelSettingsSearchFieldUnavailable"] = "Nicht genug Platz für ein eingeblendetes Suchfeld in diesem Panel.",
                    ["Loc.PanelSettingsSettingsVisibility"] = "Einstellungen",
                    ["Loc.PanelSettingsSettingsAlways"] = "Anzeigen",
                    ["Loc.PanelSettingsSettingsExpandedOnly"] = "Nur aufgeklappt",
                    ["Loc.PanelSettingsSettingsHidden"] = "Ausblenden",
                    ["Loc.PanelSettingsHeaderAlignment"] = "Titel/Tabs",
                    ["Loc.PanelSettingsAlignLeft"] = "Links",
                    ["Loc.PanelSettingsAlignCenter"] = "Mittig",
                    ["Loc.PanelSettingsAlignRight"] = "Rechts",
                    ["Loc.PanelSettingsGlobalHint"] = "Gilt als Standard im Layout. Bereits abweichende Panel-Werte bleiben unverändert.",
                    ["Loc.PanelSettingsCollapseBehavior"] = "Minimieren",
                    ["Loc.PanelSettingsCollapseDoubleClick"] = "Per Doppelklick",
                    ["Loc.PanelSettingsCollapseButton"] = "Button",
                    ["Loc.PanelSettingsCollapseBoth"] = "Beides",
                    ...
                    ["Loc.PanelSettingsFitWidth"] = "Breite anpassen",
                    ["Loc.PanelSettingsFitHeight"] = "Höhe anpassen",
                    ...
                    ["Loc.MsgDeletePermanentSingle"] = "Soll \"{0}\" dauerhaft gelöscht werden?",
                    ["Loc.MsgDeletePermanentMulti"] = "Sollen {0} Elemente dauerhaft gelöscht werden?",
                    ["Loc.MsgDeletePermanentError"] = "Element konnte nicht dauerhaft gelöscht werden:\n{0}",
                    ...
                    ["Loc.MsgUpdateBackupFailed"] = "Das Update-Backup konnte nicht erstellt werden. Die Installation wurde abgebrochen.\n\n{0}",
                    ["Loc.MsgBackupRestoreFailed"] = "Die Backup-Wiederherstellung konnte nicht gestartet werden.\n\n{0}",
                    ["Loc.MsgBackupRestoreLaunchMissing"] = "DesktopPlus konnte nach der Wiederherstellung nicht automatisch gestartet werden.",
                    ...
                    ["Loc.UpdateStatusBackingUp"] = "Backup vor dem Update wird erstellt...",
                    ["Loc.UpdateStatusInstalling"] = "Update {0} wird installiert...",
                    ["Loc.UpdateInstallerReadyTitle"] = "Update bereit",
                    ["Loc.UpdateInstallerReadyBody"] = "Update {0} wurde heruntergeladen. Installation ist beim nächsten Start bereit.",
                    ["Loc.BackupRestoreRefreshButton"] = "Aktualisieren",
                    ["Loc.BackupRestoreCancelButton"] = "Abbrechen",
                    ["Loc.BackupRestoreApplyButton"] = "Wiederherstellen",
                    ["Loc.BackupRestoreEmpty"] = "Es wurden noch keine Update-Backups gefunden.",
                    ["Loc.BackupRestoreNoSelection"] = "Wähle links ein Backup aus, um Details und Inhalte anzuzeigen.",
                    ["Loc.BackupRestoreCreated"] = "Erstellt",
                    ["Loc.BackupRestoreFileName"] = "Archivdatei",
                    ["Loc.BackupRestoreFileSize"] = "Größe",
                    ["Loc.BackupRestoreVersions"] = "Versionen",
                    ["Loc.BackupRestoreIncludes"] = "Enthalten",
                    ["Loc.BackupRestoreSourceDir"] = "Installationsordner",
                    ["Loc.BackupRestoreContainsApp"] = "Programmdateien der gesicherten Version",
                    ["Loc.BackupRestoreContainsSettings"] = "Panel- und App-Einstellungen",
                    ["Loc.BackupRestoreContainsLanguages"] = "Benutzerdefinierte Sprachdateien",
                    ["Loc.BackupRestoreContainsAutoSort"] = "Auto-Sort-Speicher",
                    ["Loc.BackupRestoreConfirmTitle"] = "Backup wiederherstellen",
                    ["Loc.BackupRestoreConfirm"] = "Soll das Backup \"{0}\" jetzt wiederhergestellt werden?\n\nDesktopPlus wird geschlossen und danach mit dem wiederhergestellten Stand neu gestartet.",
                ...
                ["en"] = new Dictionary<string, string>
                {
                    ...
                    ["Loc.BackupsTitle"] = "Manage backups",
                    ["Loc.BackupsDesc"] = "Automatic backups protect the state before auto-sort, updates, and critical changes. Manual backups can be created, restored, and deleted at any time.",
                    ["Loc.BackupsCreate"] = "Create backup",
                    ["Loc.BackupsRefresh"] = "Refresh",
                    ["Loc.BackupsOpenFolder"] = "Open backup folder",
                    ["Loc.BackupsEmpty"] = "No backups have been created yet.",
                    ["Loc.BackupsNoSelection"] = "Select a backup to inspect its contents and restore reason.",
                    ["Loc.BackupsCount"] = "{0} backups",
                    ["Loc.BackupsTypeLabel"] = "Type",
                    ["Loc.BackupsReasonLabel"] = "Reason",
                    ["Loc.BackupsTypeManual"] = "Manual",
                    ["Loc.BackupsTypeAutoSort"] = "Before auto-sort",
                    ["Loc.BackupsTypeCritical"] = "Safety backup",
                    ["Loc.BackupsTypeUpdate"] = "Before update",
                    ["Loc.BackupsRestore"] = "Restore",
                    ["Loc.BackupsDelete"] = "Delete",
                    ["Loc.BackupsCreating"] = "Creating backup...",
                    ["Loc.BackupsCreated"] = "Backup created.",
                    ["Loc.BackupsCreateFailed"] = "Backup could not be created: {0}",
                    ["Loc.BackupsDeleted"] = "Backup deleted.",
                    ["Loc.BackupsDeleteFailed"] = "Backup could not be deleted: {0}",
                    ["Loc.BackupsDeleteTitle"] = "Delete backup",
                    ["Loc.BackupsDeleteConfirm"] = "Permanently delete backup \"{0}\"?",
                    ["Loc.BackupsContainsDesktop"] = "Affected desktop files and folders",
                    ["Loc.BackupsReasonManual"] = "Created manually by the user",
                    ["Loc.BackupsNameManual"] = "Manual backup",
                    ["Loc.BackupsReasonAutoSort"] = "Created automatically before moving desktop items",
                    ["Loc.BackupsNameBeforeAutoSort"] = "State before auto-sort",
                    ["Loc.BackupsReasonBeforeRestore"] = "Safety copy before restoring another backup",
                    ["Loc.BackupsNameBeforeRestore"] = "State before restore",
                    ["Loc.BackupsReasonBeforeLayout"] = "Safety copy before applying a layout",
                    ["Loc.BackupsReasonBeforeLayoutUpdate"] = "Safety copy before overwriting a layout",
                    ["Loc.BackupsReasonBeforePanelDelete"] = "Safety copy before deleting a panel",
                    ["Loc.BackupsReasonBeforeLayoutDelete"] = "Safety copy before deleting a layout",
                    ["Loc.BackupsReasonBeforeRulesReset"] = "Safety copy before resetting auto-sort rules",
                    ["Loc.BackupsReasonBeforePresetDelete"] = "Safety copy before deleting a theme preset",
                    ["Loc.BackupsReasonBeforePresetReset"] = "Safety copy before resetting default presets",
                    ["Loc.BackupsSafetyFailed"] = "The safety backup could not be created. The action was cancelled.\n\n{0}",
                    ["Loc.AutoSortMsgBackupFailed"] = "Auto-sort was cancelled because the safety backup could not be created:\n{0}",
                    ...
                    ["Loc.ShortcutsNotifyConflict"] = "Notify on shortcut conflict",
                    ["Loc.ShortcutsPriorityAbove"] = "Force the shortcut above the blocking program",
                    ["Loc.ShortcutsPriorityHint"] = "Enables a global keyboard hook so DesktopPlus still receives the combination even when another program has claimed it. Without the check mark, DesktopPlus yields to the other program.",
                    ["Loc.ShortcutConflictTitle"] = "Shortcut conflict",
                    ["Loc.ShortcutConflictBodyBelow"] = "The hotkey \"{0}\" is used by another program and is currently inactive.",
                    ["Loc.ShortcutConflictBodyAbove"] = "The hotkey \"{0}\" is used by another program — DesktopPlus has taken priority.",
                    ["Loc.ShortcutsExistingTitle"] = "Panel shortcuts",
                    ...
                    ["Loc.ShortcutsRegisterWarning"] = "Hotkey could not be registered: {0}. It may already be in use by another app — please choose a different combination and click Apply.",
                    ["Loc.TabCompanion"] = "Companion",
                    ["Loc.CompanionTitle"] = "Phone companion",
                    ["Loc.CompanionDesc"] = "Access your panels and files from your phone — ideal while a full-screen game is running on the PC. Same Wi-Fi only, encrypted over HTTPS.",
                    ["Loc.CompanionEnable"] = "Enable companion server",
                    ["Loc.CompanionStatusDisabled"] = "Companion is disabled.",
                    ["Loc.CompanionStatusRunning"] = "Active. Scan the QR code with your phone on the same Wi-Fi.",
                    ["Loc.CompanionStatusError"] = "Server is not running. The port may be in use — see the message.",
                    ["Loc.CompanionScanHint"] = "Scan the QR code with your phone camera, then accept the certificate warning once in the browser (self-signed).",
                    ["Loc.CompanionUrlLabel"] = "Address",
                    ["Loc.CompanionCopyUrl"] = "Copy link",
                    ["Loc.CompanionRegenerate"] = "Regenerate token",
                    ["Loc.CompanionSecurityNote"] = "Use only on a trusted home network. The token is the key to your files — don't share it and don't expose/port-forward it to the internet. \"Regenerate token\" disconnects existing phone sessions.",
                    ["Loc.CompanionStartFailed"] = "Could not start the companion server: {0}",
                    ...
                    ["Loc.PanelTypeRecycleBin"] = "Recycle Bin",
                    ...
                    ["Loc.PanelNavigateUpTooltip"] = "Go to parent folder",
                    ["Loc.PanelSearchPlaceholder"] = "Search...",
                    ["Loc.PanelSearchShowTooltip"] = "Open search",
                    ...
                    ["Loc.PanelSettingsShowBackButton"] = "Show back button",
                    ["Loc.PanelSettingsBackNavigation"] = "Back navigation",
                    ["Loc.PanelSettingsBackNavigationHeader"] = "Header back button",
                    ["Loc.PanelSettingsBackNavigationParentItem"] = "Parent folder item",
                    ["Loc.PanelSettingsBackNavigationNone"] = "No back navigation",
                    ["Loc.PanelSettingsShowFileExtensions"] = "Show file extensions",
                    ["Loc.PanelSettingsShowSettingsButton"] = "Show settings button",
                    ["Loc.PanelSettingsShowCloseButton"] = "Show close button",
                    ["Loc.PanelSettingsShowEmptyRecycleBin"] = "Show clear button",
                    ["Loc.EmptyRecycleBinButton"] = "Empty",
                    ["Loc.EmptyRecycleBinTitle"] = "Empty Recycle Bin",
                    ["Loc.EmptyRecycleBinConfirm"] = "Are you sure you want to permanently empty the Recycle Bin? This action cannot be undone.",
                    ["Loc.EmptyFolderTitle"] = "Empty folder",
                    ["Loc.EmptyFolderConfirm"] = "Are you sure you want to empty \"{0}\"? All contents will be moved to the Recycle Bin.",
                    ...
                    ["Loc.PanelSettingsColumns"] = "Detail columns",
                    ["Loc.PanelSettingsColumnsHint"] = "Choose visible columns and extra metadata.",
                    ["Loc.PanelSettingsChooseColumns"] = "Choose columns...",
                    ["Loc.PanelSettingsMetaAuthors"] = "Authors",
                    ["Loc.PanelSettingsMetaCategories"] = "Categories",
                    ["Loc.PanelSettingsMetaTags"] = "Tags",
                    ["Loc.PanelSettingsMetaTitle"] = "Title",
                    ["Loc.DetailColumnName"] = "Name",
                    ["Loc.DetailColumnsDialogTitle"] = "Choose detail columns",
                    ["Loc.DetailColumnsDialogHint"] = "Show or hide the columns that appear in the list view.",
                    ["Loc.DetailColumnsAutoFitColumn"] = "Adjust column width",
                    ["Loc.DetailColumnsAutoFitAll"] = "Adjust all column widths",
                    ["Loc.DetailColumnsMore"] = "More...",
                    ["Loc.Cancel"] = "Cancel",
                    ["Loc.Apply"] = "Apply",
                    ["Loc.PanelSettingsMovement"] = "Movement",
                    ["Loc.PanelSettingsSearchVisibility"] = "Search",
                    ["Loc.PanelSettingsSearchAlways"] = "Search field",
                    ["Loc.PanelSettingsSearchButtonOnly"] = "Search button",
                    ["Loc.PanelSettingsSearchExpandedOnly"] = "Expanded panel only",
                    ["Loc.PanelSettingsSearchHidden"] = "Hide",
                    ["Loc.PanelSettingsSearchFieldUnavailable"] = "Not enough space for an inline search field in this panel.",
                    ["Loc.PanelSettingsSettingsVisibility"] = "Settings",
                    ["Loc.PanelSettingsSettingsAlways"] = "Show",
                    ["Loc.PanelSettingsSettingsExpandedOnly"] = "Expanded panel only",
                    ["Loc.PanelSettingsSettingsHidden"] = "Hide",
                    ["Loc.PanelSettingsHeaderAlignment"] = "Title/Tabs",
                    ["Loc.PanelSettingsAlignLeft"] = "Left",
                    ["Loc.PanelSettingsAlignCenter"] = "Center",
                    ["Loc.PanelSettingsAlignRight"] = "Right",
                    ["Loc.PanelSettingsGlobalHint"] = "Used as layout default. Panels with custom values are kept unchanged.",
                    ["Loc.PanelSettingsCollapseBehavior"] = "Minimize",
                    ["Loc.PanelSettingsCollapseDoubleClick"] = "Double-click",
                    ["Loc.PanelSettingsCollapseButton"] = "Button",
                    ["Loc.PanelSettingsCollapseBoth"] = "Both",
                    ["Loc.MovementTitlebar"] = "Drag title bar",
                    ["Loc.MovementButton"] = "Move button",
                    ["Loc.MovementLocked"] = "Locked",
                    ["Loc.PanelSettingsFitContent"] = "Fit to content",
                    ["Loc.PanelSettingsFitWidth"] = "Fit width",
                    ["Loc.PanelSettingsFitHeight"] = "Fit height",
                    ...
                    ["Loc.MsgDeletePermanentSingle"] = "Permanently delete \"{0}\"?",
                    ["Loc.MsgDeletePermanentMulti"] = "Permanently delete {0} items?",
                    ["Loc.MsgDeletePermanentError"] = "Could not permanently delete item:\n{0}",
                    ...
                    ["Loc.MsgUpdateBackupFailed"] = "The update backup could not be created. Installation was cancelled.\n\n{0}",
                    ["Loc.MsgBackupRestoreFailed"] = "Backup restore could not be started.\n\n{0}",
                    ["Loc.MsgBackupRestoreLaunchMissing"] = "DesktopPlus could not be started automatically after the restore.",
                    ...
                    ["Loc.UpdateStatusBackingUp"] = "Creating backup before update...",
                    ...
                    ["Loc.BackupRestoreRefreshButton"] = "Refresh",
                    ["Loc.BackupRestoreCancelButton"] = "Cancel",
                    ["Loc.BackupRestoreApplyButton"] = "Restore",
                    ["Loc.BackupRestoreEmpty"] = "No update backups were found yet.",
                    ["Loc.BackupRestoreNoSelection"] = "Select a backup on the left to inspect its details and contents.",
                    ["Loc.BackupRestoreCreated"] = "Created",
                    ["Loc.BackupRestoreFileName"] = "Archive file",
                    ["Loc.BackupRestoreFileSize"] = "Size",
                    ["Loc.BackupRestoreVersions"] = "Versions",
                    ["Loc.BackupRestoreIncludes"] = "Includes",
                    ["Loc.BackupRestoreSourceDir"] = "Install directory",
                    ["Loc.BackupRestoreContainsApp"] = "Application files of the backed up version",
                    ["Loc.BackupRestoreContainsSettings"] = "Panel and app settings",
                    ["Loc.BackupRestoreContainsLanguages"] = "Custom language files",
                    ["Loc.BackupRestoreContainsAutoSort"] = "Auto-sort storage",
                    ["Loc.BackupRestoreConfirmTitle"] = "Restore backup",
                    ["Loc.BackupRestoreConfirm"] = "Restore backup \"{0}\" now?\n\nDesktopPlus will close and restart with the restored state afterwards.",
        ...
        private static void EnsureBuiltInLanguages()
        {
            ...
            if (LocalizationData.TryGetValue("de", out var german))
            {
                ...
                german["Loc.ShortcutOpenSelection"] = "Ausgewähltes Element öffnen.";
                german["Loc.ShortcutRefreshPanel"] = "Aktuelles Panel aktualisieren.";
                german["Loc.ShortcutParentFolder"] = "Zum übergeordneten Ordner wechseln.";
            }
            ...
            english["Loc.ShortcutRefreshPanel"] = "Refresh the current panel.";
            english["Loc.ShortcutParentFolder"] = "Go to the parent folder.";
            ...
            var latvian = new Dictionary<string, string>(english, StringComparer.OrdinalIgnoreCase)
            {
                ...
                ["Loc.UpdateDialogOpenReleaseButton"] = "Atvērt relīzes lapu",
                ...
                ["Loc.MsgUpdateBackupFailed"] = "Neizdevās izveidot atjauninājuma dublējumu. Instalēšana tika atcelta.\n\n{0}",
                ...
                ["Loc.UpdateStatusBackingUp"] = "Veido dublējumu pirms atjaunināšanas...",
            ...
            latvian["Loc.ShortcutOpenSelection"] = "Atvērt atlasīto vienumu.";
            latvian["Loc.ShortcutRefreshPanel"] = "Atsvaidzināt pašreizējo paneli.";
            latvian["Loc.ShortcutParentFolder"] = "Pāriet uz vecākmapi.";
            latvian["Loc.AutoSortRuleFolders"] = "Mapes";
            latvian["Loc.AutoSortRuleImages"] = "Attēli";
            latvian["Loc.AutoSortRuleVideos"] = "Video";
            latvian["Loc.AutoSortRuleAudio"] = "Audio";
            latvian["Loc.AutoSortRuleDocuments"] = "Dokumenti";
            latvian["Loc.AutoSortRuleArchives"] = "Arhīvi";
            latvian["Loc.AutoSortRuleInstallers"] = "Instalētāji un skripti";
            latvian["Loc.AutoSortRuleShortcuts"] = "Īsceļi";
            latvian["Loc.AutoSortRuleCode"] = "Koda faili";
            latvian["Loc.AutoSortRuleOthers"] = "Citi";
            latvian["Loc.AutoSortPanelFolders"] = "Mapes";
            latvian["Loc.AutoSortPanelImages"] = "Attēli";
            latvian["Loc.AutoSortPanelVideos"] = "Video";
            latvian["Loc.AutoSortPanelAudio"] = "Audio";
            latvian["Loc.AutoSortPanelDocuments"] = "Dokumenti";
            latvian["Loc.AutoSortPanelArchives"] = "Arhīvi";
            latvian["Loc.AutoSortPanelInstallers"] = "Instalētāji";
            latvian["Loc.AutoSortPanelShortcuts"] = "Īsceļi";
            latvian["Loc.AutoSortPanelCode"] = "Kods";
            latvian["Loc.AutoSortPanelOthers"] = "Citi";
            foreach (var pair in new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                ["Loc.LanguageEnglish"] = "Angļu",
                ["Loc.LanguageLatvian"] = "Latviešu",
                ["Loc.GeneralStartupCheckbox"] = "Palaist kopā ar Windows",
                ["Loc.GeneralUpdatesLabel"] = "Atjauninājumi",
                ["Loc.GeneralAutoUpdateCheckbox"] = "Automātiski instalēt atjauninājumus",
                ["Loc.GeneralCheckUpdatesButton"] = "Pārbaudīt atjauninājumus",
                ["Loc.GeneralImportLanguageButton"] = "Importēt valodas JSON",
                ["Loc.GeneralCurrentVersion"] = "Instalētā versija: {0}",
                ["Loc.CloseBehaviorMinimize"] = "Minimizēt",
                ["Loc.PanelsTitle"] = "Paneļi",
                ["Loc.PanelsNew"] = "Jauns panelis",
                ["Loc.PanelsDesc"] = "Pārskats pa paneļiem.",
                ["Loc.PanelsHide"] = "Paslēpt",
                ["Loc.PanelsShow"] = "Rādīt",
                ...
                ["Loc.LayoutsCreateEmpty"] = "Pievienot tukšu",
                ["Loc.LayoutsDesc"] = "Izkārtojumi saglabā redzamos paneļus, pozīcijas un tēmu.",
                ["Loc.LayoutsApply"] = "Ielādēt",
                ["Loc.LayoutsUpdate"] = "Saglabāt pašreizējo izkārtojumu",
                ["Loc.LayoutsDelete"] = "Dzēst",
                ["Loc.LayoutsDefaultPreset"] = "Noklusējuma priekšiestatījums",
                ["Loc.LayoutsGlobalPanelSettings"] = "Globālie paneļu iestatījumi",
                ["Loc.ThemesTitle"] = "Priekšiestatījumu izvēle",
                ["Loc.ThemesDesc"] = "Izvēlieties priekšiestatījumu vai izveidojiet savu.",
                ["Loc.ThemesPresetTooltip"] = "Jauns priekšiestatījums",
                ["Loc.ThemesCreate"] = "Izveidot",
                ["Loc.ThemesApplyAll"] = "Pielietot visiem",
                ["Loc.ThemesSave"] = "Saglabāt",
                ["Loc.ThemesDelete"] = "Dzēst",
                ["Loc.ThemesResetDefaults"] = "Atiestatīt noklusējumus",
                ["Loc.ThemesSection"] = "Sadaļa",
                ["Loc.ThemesSectionHeader"] = "Galvene",
                ["Loc.ThemesSectionBody"] = "Pamatdaļa",
                ["Loc.ThemesSectionTabs"] = "Cilnes",
                ["Loc.FineTuneTitle"] = "Precīza pielāgošana",
                ["Loc.LabelBackgroundColor"] = "Fona krāsa",
                ["Loc.LabelHeaderColor"] = "Galvenes krāsa",
                ["Loc.LabelOpacity"] = "Necaurspīdīgums",
                ["Loc.LabelAccentColor"] = "Akcenta krāsa",
                ["Loc.TypographyTitle"] = "Tipogrāfija",
                ["Loc.LabelFontFamily"] = "Fonts",
                ["Loc.LabelTextColor"] = "Teksta krāsa",
                ["Loc.LabelFolderColor"] = "Mapju krāsa",
                ["Loc.LabelTabActiveColor"] = "Aktīvās cilnes krāsa",
                ["Loc.LabelTabInactiveColor"] = "Neaktīvās cilnes krāsa",
                ["Loc.LabelTabHoverColor"] = "Cilnes krāsa, uzvedot peli",
                ["Loc.LabelTitleSize"] = "Virsraksta lielums",
                ["Loc.LabelItemSize"] = "Vienuma teksta lielums",
                ["Loc.LabelCornerRadius"] = "Stūru rādiuss",
                ["Loc.LabelShadow"] = "Ēna",
                ["Loc.LabelHeaderShadow"] = "Galvene",
                ["Loc.LabelBodyShadow"] = "Pamatdaļa",
                ["Loc.LabelMode"] = "Režīms",
                ["Loc.ModeSolid"] = "Vienkrāsains",
                ["Loc.ModeImage"] = "Attēls",
                ["Loc.ModePattern"] = "Raksts",
                ["Loc.LabelPattern"] = "Raksts",
                ["Loc.PatternNone"] = "Nav",
                ["Loc.PatternDiagonal"] = "Diagonāls",
                ["Loc.PatternGrid"] = "Režģis",
                ["Loc.PatternDots"] = "Punkti",
                ["Loc.PatternCustom"] = "Pielāgots",
                ["Loc.LabelPatternColor"] = "Raksta krāsa",
                ["Loc.LabelPatternOpacity"] = "Raksta necaurspīdīgums",
                ["Loc.LabelPatternTileSize"] = "Flīzes lielums",
                ["Loc.LabelPatternStroke"] = "Līnijas biezums",
                ["Loc.PatternEditorHint"] = "Ar kreiso zīmē, ar labo dzēš",
                ["Loc.ButtonPatternClear"] = "Notīrīt",
                ["Loc.LabelBackgroundImage"] = "Fona attēls",
                ["Loc.OptionGlass"] = "Stikla efekts",
                ["Loc.OptionImageFill"] = "Aizpildīt attēlu",
                ["Loc.LabelImageGlassIntensity"] = "Attēla/stikla intensitāte",
                ["Loc.PreviewTitle"] = "Priekšskatījums",
                ["Loc.PreviewFolderDocs"] = "Dokumenti",
                ["Loc.PreviewFolderPhotos"] = "Attēli",
                ["Loc.PreviewFolderProjects"] = "Projekti",
                ["Loc.ShortcutsTitle"] = "Saīsnes",
                ["Loc.ShortcutsDesc"] = "Pieejamo tastatūras un peles saīsņu pārskats.",
                ["Loc.ShortcutsGlobalTitle"] = "Globālie karstie taustiņi",
                ["Loc.ShortcutsGlobalHint"] = "Noklikšķiniet laukā un nospiediet taustiņu kombināciju, pēc tam saglabājiet ar Piemērot.",
                ["Loc.ShortcutsNotifyConflict"] = "Paziņot par saīsnes konfliktu",
                ["Loc.ShortcutsPriorityAbove"] = "Uzspiest saīsni virs bloķējošās programmas",
                ["Loc.ShortcutsPriorityHint"] = "Iespējo globālu tastatūras āķi, lai DesktopPlus saņemtu kombināciju arī tad, ja to izmanto cita programma. Bez atzīmes DesktopPlus dod priekšroku citai programmai.",
                ["Loc.ShortcutConflictTitle"] = "Saīsnes konflikts",
                ["Loc.ShortcutConflictBodyBelow"] = "Karsto taustiņu \"{0}\" izmanto cita programma, un tas pašlaik nav aktīvs.",
                ["Loc.ShortcutConflictBodyAbove"] = "Karsto taustiņu \"{0}\" izmanto cita programma — DesktopPlus ir pārņēmis prioritāti.",
                ["Loc.ShortcutsExistingTitle"] = "Paneļu saīsnes",
                ["Loc.ShortcutsInputHide"] = "Rādīt/paslēpt paneļus",
                ["Loc.ShortcutsInputForeground"] = "Pārvietot paneļus priekšplānā",
                ["Loc.ShortcutsApply"] = "Piemērot",
                ["Loc.ShortcutsReset"] = "Noklusējums",
                ["Loc.ShortcutHideAllPanels"] = "Pārslēgt visu paneļu rādīšanu vai paslēpšanu.",
                ["Loc.ShortcutTemporaryForeground"] = "Īslaicīgi pārvietot visus atvērtos paneļus priekšplānā.",
                ["Loc.ShortcutDeleteSelection"] = "Dzēst atlasi (pārvietot failus uz atkritni vai izņemt no saraksta).",
                ["Loc.ShortcutCopySelection"] = "Kopēt atlasi starpliktuvē.",
                ["Loc.ShortcutCutSelection"] = "Izgriezt atlasi.",
                ["Loc.ShortcutPasteSelection"] = "Ielīmēt failus no starpliktuves.",
                ["Loc.ShortcutPanelZoom"] = "Palielināt vai samazināt paneļa saturu.",
                ["Loc.ShortcutAdditiveSelection"] = "Pārslēgt papildinošo vairākatlasi.",
                ["Loc.ShortcutRangeSelection"] = "Diapazona atlase failu sarakstā.",
                ["Loc.ShortcutClassicContextMenu"] = "Atvērt klasisko Windows kontekstizvēlni panelī.",
                ["Loc.ShortcutDragCopy"] = "Piespiest kopēšanu vilkšanas un nomešanas laikā.",
                ["Loc.ShortcutDragMove"] = "Piespiest pārvietošanu vilkšanas un nomešanas laikā.",
                ["Loc.ShortcutDragLink"] = "Izveidot saiti vilkšanas un nomešanas laikā.",
                ["Loc.ShortcutTrayClose"] = "Aizvērt sistēmas joslas izvēlni.",
                ["Loc.ShortcutFitContent"] = "Pielāgot paneļa izmēru saturam.",
                ["Loc.ShortcutSelectAll"] = "Atlasīt visus redzamos vienumus.",
                ["Loc.ShortcutFocusSearch"] = "Fokusēt meklēšanu.",
                ["Loc.ShortcutRenameSelection"] = "Pārdēvēt atlasīto vienumu.",
                ["Loc.ShortcutOpenSelection"] = "Atvērt atlasīto vienumu.",
                ["Loc.ShortcutRefreshPanel"] = "Atsvaidzināt pašreizējo paneli.",
                ["Loc.ShortcutParentFolder"] = "Pāriet uz vecākmapi.",
                ["Loc.AutoSortTitle"] = "Automātiska darbvirsmas sakārtošana",
                ["Loc.AutoSortDesc"] = "Sakārto darbvirsmas failus un mapes pēc noteikumiem atsevišķos mērķa paneļos.",
                ["Loc.AutoSortToggle"] = "Vienmēr automātiski kārtot jaunus darbvirsmas vienumus",
                ["Loc.AutoSortRunNow"] = "Kārtot tagad",
                ["Loc.AutoSortResetRules"] = "Atiestatīt noteikumus",
                ["Loc.AutoSortBuiltInTitle"] = "Iebūvētie noteikumi",
                ["Loc.AutoSortCustomTitle"] = "Pielāgoti paplašinājumi",
                ["Loc.AutoSortCustomHint"] = "Piemēra paplašinājumi: .blend .psd .sketch",
                ["Loc.AutoSortRuleType"] = "Tips",
                ["Loc.AutoSortRuleExtensions"] = "Paplašinājumi",
                ["Loc.AutoSortRuleTarget"] = "Mērķa panelis",
                ["Loc.AutoSortCustomExtensionsLabel"] = "Jauni paplašinājumi",
                ["Loc.AutoSortCustomTargetLabel"] = "Mērķa panelis",
                ["Loc.AutoSortCustomAdd"] = "Pievienot noteikumu",
                ["Loc.AutoSortRemove"] = "Noņemt",
                ["Loc.AutoSortExtensionsFolders"] = "(Mapes)",
                ["Loc.AutoSortExtensionsCatchAll"] = "(Visi pārējie faili)",
                ["Loc.AutoSortRuleImages"] = "Attēli",
                ["Loc.AutoSortRuleArchives"] = "Arhīvi",
                ["Loc.AutoSortRuleInstallers"] = "Instalētāji un skripti",
                ["Loc.AutoSortRuleShortcuts"] = "Īsceļi",
                ["Loc.AutoSortPanelImages"] = "Attēli",
                ["Loc.AutoSortPanelArchives"] = "Arhīvi",
                ["Loc.AutoSortPanelInstallers"] = "Instalētāji",
                ["Loc.AutoSortPanelShortcuts"] = "Īsceļi",
                ["Loc.AutoSortStatusDisabled"] = "Auto kārtošana ir izslēgta.",
                ["Loc.AutoSortStatusEnabled"] = "Auto kārtošana ir aktīva un vēro jūsu darbvirsmu.",
                ["Loc.AutoSortCustomRuleNameFormat"] = "Pielāgots ({0})",
                ["Loc.AutoSortMsgInvalidExtensions"] = "Lūdzu, norādiet vismaz vienu derīgu paplašinājumu (piemēram, .psd .blend).",
                ["Loc.AutoSortMsgRuleAdded"] = "Jauns noteikums pievienots.",
                ["Loc.AutoSortMsgRuleRemoved"] = "Noteikums noņemts.",
                ["Loc.AutoSortMsgSortDone"] = "{0} darbvirsmas vienum(i) tika sakārtoti.",
                ["Loc.AutoSortMsgSortDoneWithErrors"] = "{0} vienum(i) sakārtoti, {1} neizdevās pārvietot.",
                ["Loc.AutoSortMsgSortNoItems"] = "Netika atrasti jauni darbvirsmas vienumi, ko sakārtot.",
                ["Loc.AutoSortMsgSortFailed"] = "Automātiskā kārtošana neizdevās:\n{0}",
                ["Loc.PanelTypeRecycleBin"] = "Atkritne",
                ["Loc.PanelWindowTitle"] = "Panelis",
                ["Loc.PanelDefaultTitle"] = "Panelis",
                ["Loc.PanelMoveTooltip"] = "Pārvietot logu",
                ["Loc.PanelSettingsTooltip"] = "Paneļa iestatījumi",
                ["Loc.PanelNavigateUpTooltip"] = "Doties uz virsmapes mapi",
                ["Loc.PanelSearchPlaceholder"] = "Meklēt...",
                ["Loc.PanelSearchShowTooltip"] = "Atvērt meklēšanu",
                ["Loc.PanelCollapseTooltip"] = "Sakļaut/izvērst saturu",
                ["Loc.PanelCloseTooltip"] = "Aizvērt",
                ["Loc.PanelSettingsTitle"] = "Paneļa iestatījumi",
                ["Loc.PanelSettingsName"] = "Nosaukums",
                ["Loc.PanelSettingsPreset"] = "Priekšiestatījums",
                ["Loc.PanelSettingsDefaultFolder"] = "Noklusējuma mape",
                ["Loc.PanelSettingsFolderUnset"] = "(nav iestatīta)",
                ["Loc.PanelSettingsChange"] = "Mainīt",
                ["Loc.PanelSettingsFolderAction"] = "Mapes darbība",
                ["Loc.PanelSettingsOpenInternal"] = "Navigēt panelī",
                ["Loc.PanelSettingsOpenExternal"] = "Atvērt Explorer",
                ["Loc.PanelSettingsOpenBehavior"] = "Atvērt ar",
                ["Loc.PanelSettingsOpenByDoubleClick"] = "Dubultklikšķis (noklusējums)",
                ["Loc.PanelSettingsOpenBySingleClick"] = "Viens klikšķis",
                ["Loc.PanelSettingsExpandOnHover"] = "Izvērst, uzvedot peli",
                ["Loc.PanelSettingsShowHidden"] = "Rādīt slēptos vienumus",
                ["Loc.PanelSettingsShowParentFolder"] = "Rādīt vecākmapi",
                ["Loc.PanelSettingsShowBackButton"] = "Rādīt atpakaļpogu",
                ["Loc.PanelSettingsBackNavigation"] = "Atpakaļnavigācija",
                ["Loc.PanelSettingsBackNavigationHeader"] = "Augšējā atpakaļpoga",
                ["Loc.PanelSettingsBackNavigationParentItem"] = "Vecākmape kā ieraksts",
                ["Loc.PanelSettingsBackNavigationNone"] = "Bez atpakaļnavigācijas",
                ["Loc.PanelSettingsShowFileExtensions"] = "Rādīt failu paplašinājumus",
                ["Loc.PanelSettingsShowSettingsButton"] = "Rādīt iestatījumu pogu",
                ["Loc.PanelSettingsShowCloseButton"] = "Rādīt aizvēršanas pogu",
                ["Loc.PanelSettingsShowEmptyRecycleBin"] = "Rādīt mapes iztukšošanas pogu",
                ["Loc.EmptyRecycleBinButton"] = "Iztukšot",
                ["Loc.EmptyRecycleBinTitle"] = "Iztukšot atkritni",
                ["Loc.EmptyRecycleBinConfirm"] = "Vai tiešām vēlaties neatgriezeniski iztukšot atkritni? Šo darbību nevar atsaukt.",
                ["Loc.EmptyFolderTitle"] = "Iztukšot mapi",
                ["Loc.EmptyFolderConfirm"] = "Vai tiešām vēlaties iztukšot mapi \"{0}\"? Viss saturs tiks pārvietots uz atkritni.",
                ["Loc.PanelSettingsActions"] = "Darbības",
                ["Loc.PanelSettingsViewMode"] = "Skata režīms",
                ["Loc.PanelSettingsViewIcons"] = "Flīzes",
                ["Loc.PanelSettingsViewDetails"] = "Detalizēts saraksts",
                ["Loc.PanelSettingsViewPhotos"] = "Fotoalbums",
                ["Loc.PanelSettingsMetadata"] = "Metadati",
                ["Loc.PanelSettingsMetaType"] = "Faila tips",
                ["Loc.PanelSettingsMetaSize"] = "Faila lielums",
                ["Loc.PanelSettingsMetaCreated"] = "Izveidots",
                ["Loc.PanelSettingsMetaModified"] = "Mainīts",
                ["Loc.PanelSettingsMetaDimensions"] = "Attēla izmērs",
                ["Loc.PanelSettingsColumns"] = "Detalizētās kolonnas",
                ["Loc.PanelSettingsColumnsHint"] = "Izvēlieties redzamās kolonnas un papildu metadatus.",
                ["Loc.PanelSettingsChooseColumns"] = "Izvēlēties kolonnas...",
                ["Loc.PanelSettingsMetaAuthors"] = "Autori",
                ["Loc.PanelSettingsMetaCategories"] = "Kategorijas",
                ["Loc.PanelSettingsMetaTags"] = "Atzīmes",
                ["Loc.PanelSettingsMetaTitle"] = "Nosaukums",
                ["Loc.DetailColumnName"] = "Nosaukums",
                ["Loc.DetailColumnsDialogTitle"] = "Izvēlēties detalizētās kolonnas",
                ["Loc.DetailColumnsDialogHint"] = "Parādiet vai paslēpiet kolonnas, kas redzamas saraksta skatā.",
                ["Loc.DetailColumnsAutoFitColumn"] = "Pielāgot kolonnas platumu",
                ["Loc.DetailColumnsAutoFitAll"] = "Pielāgot visu kolonnu platumu",
                ["Loc.DetailColumnsMore"] = "Vairāk...",
                ["Loc.Cancel"] = "Atcelt",
                ["Loc.Apply"] = "Piemērot",
                ["Loc.PanelSettingsMovement"] = "Pārvietošana",
                ["Loc.PanelSettingsSearchVisibility"] = "Meklēšana",
                ["Loc.PanelSettingsSearchAlways"] = "Meklēšanas lauks",
                ["Loc.PanelSettingsSearchButtonOnly"] = "Meklēšanas poga",
                ["Loc.PanelSettingsSearchExpandedOnly"] = "Tikai atvērtā panelī",
                ["Loc.PanelSettingsSearchHidden"] = "Slēpt",
                ["Loc.PanelSettingsSearchFieldUnavailable"] = "Šajā panelī nav pietiekami daudz vietas redzamam meklēšanas laukam.",
                ["Loc.PanelSettingsSettingsVisibility"] = "Iestatījumi",
                ["Loc.PanelSettingsSettingsAlways"] = "Rādīt",
                ["Loc.PanelSettingsSettingsExpandedOnly"] = "Tikai atvērtā panelī",
                ["Loc.PanelSettingsSettingsHidden"] = "Slēpt",
                ["Loc.PanelSettingsHeaderAlignment"] = "Virsraksts/cilnes",
                ["Loc.PanelSettingsAlignLeft"] = "Pa kreisi",
                ["Loc.PanelSettingsAlignCenter"] = "Vidū",
                ["Loc.PanelSettingsAlignRight"] = "Pa labi",
                ["Loc.PanelSettingsGlobalHint"] = "Izmanto kā izkārtojuma noklusējumu. Paneļi ar pielāgotām vērtībām netiek mainīti.",
                ["Loc.PanelSettingsCollapseBehavior"] = "Minimizēšana",
                ["Loc.PanelSettingsCollapseDoubleClick"] = "Ar dubultklikšķi",
                ["Loc.PanelSettingsCollapseButton"] = "Poga",
                ["Loc.PanelSettingsCollapseBoth"] = "Abi",
                ["Loc.MovementTitlebar"] = "Vilkt aiz virsrakstjoslas",
                ["Loc.MovementButton"] = "Pārvietošanas poga",
                ["Loc.MovementLocked"] = "Bloķēts",
                ["Loc.PanelSettingsFitContent"] = "Pielāgot saturam",
                ["Loc.PanelSettingsFitWidth"] = "Pielāgot platumu",
                ["Loc.PanelSettingsFitHeight"] = "Pielāgot augstumu",
                ["Loc.PanelSettingsCancel"] = "Atcelt",
                ["Loc.PanelSettingsResetToStandard"] = "Atjaunot noklusējumu",
                ["Loc.PanelSettingsSave"] = "Saglabāt",
                ["Loc.TabNewTab"] = "Jauna cilne",
                ["Loc.TabClose"] = "Aizvērt cilni",
                ["Loc.TabCloseOthers"] = "Aizvērt citas cilnes",
                ["Loc.TabRename"] = "Pārdēvēt cilni",
                ["Loc.InputDialogTitle"] = "Ievade",
                ["Loc.InputDialogCancel"] = "Atcelt",
                ["Loc.TrayOpen"] = "Atvērt",
                ["Loc.TrayExit"] = "Iziet",
                ["Loc.TrayStatusRunning"] = "Darbojas fonā",
                ["Loc.TrayHintEsc"] = "Nospiediet Esc, lai aizvērtu šo izvēlni",
                ["Loc.MsgError"] = "Kļūda",
                ["Loc.MsgInfo"] = "Informācija",
                ["Loc.MsgPresetNameRequired"] = "Lūdzu, ievadiet priekšiestatījuma nosaukumu.",
                ["Loc.MsgPresetBuiltIn"] = "Iebūvētos priekšiestatījumus nevar pārrakstīt. Izvēlieties citu nosaukumu.",
                ["Loc.MsgPresetBuiltInDelete"] = "Iebūvētos priekšiestatījumus nevar dzēst.",
                ["Loc.MsgPresetNameExists"] = "Priekšiestatījums ar šādu nosaukumu jau pastāv.",
                ["Loc.MsgPresetReset"] = "Noklusējuma priekšiestatījumi tika atiestatīti.",
                ["Loc.MsgResetConfirmTitle"] = "Apstipriniet atiestatīšanu",
                ["Loc.MsgResetConfirmMessage"] = "Vai tiešām vēlaties atiestatīt visus noklusējuma priekšiestatījumus?\n\nŠo darbību nevar atsaukt.",
                ["Loc.ThemesResetDefaultsFull"] = "Atiestatīt noklusējuma priekšiestatījumus",
                ["Loc.MsgUpdateAvailable"] = "Pieejama versija {0} (instalēta: {1}). Vai atvērt relīzes lapu?",
                ["Loc.MsgUpdateAvailableActions"] = "Pieejama versija {0} (instalēta: {1}).\n\nJā: Atvērt relīzes lapu\nNē: Instalēt tagad (klusi)\nAtcelt: Pārtraukt",
                ["Loc.UpdateDialogTitle"] = "Pieejams atjauninājums",
                ["Loc.UpdateDialogInstalledLabel"] = "Instalētā",
                ["Loc.UpdateDialogLatestLabel"] = "Jaunā versija",
                ["Loc.UpdateDialogChooseAction"] = "Izvēlieties darbību",
                ["Loc.UpdateDialogOpenReleaseButton"] = "Atvērt relīzes lapu",
                ["Loc.UpdateDialogInstallNowButton"] = "Instalēt tagad",
                ["Loc.UpdateDialogLaterButton"] = "Vēlāk",
                ["Loc.MsgUpdateUpToDate"] = "Jums ir jaunākā versija ({0}).",
                ["Loc.MsgUpdateCheckFailed"] = "Atjauninājumu pārbaude neizdevās:\n{0}",
                ["Loc.MsgUpdateOpenPageFailed"] = "Neizdevās atvērt relīzes lapu.",
                ["Loc.MsgUpdateNoInstallerAsset"] = "Šai versijai netika atrasts instalatora fails.",
                ...
                ["Loc.UpdateStatusBackingUp"] = "Veido dublējumu pirms atjaunināšanas...",
                ["Loc.UpdateStatusInstalling"] = "Instalē atjauninājumu {0}...",
                ["Loc.UpdateInstallerReadyTitle"] = "Atjauninājums gatavs",
                ["Loc.UpdateInstallerReadyBody"] = "Atjauninājums {0} ir lejupielādēts. Instalēšana būs gatava nākamajā palaišanas reizē.",
                ["Loc.MsgLanguageImportSuccess"] = "Valoda \"{0}\" ({1}) tika importēta.",
                ["Loc.MsgLanguageImportInvalid"] = "JSON fails nav derīga valodas pakotne.",
                ["Loc.MsgLanguageImportFailed"] = "Valodas imports neizdevās:\n{0}",
                ["Loc.MsgLanguageImportReservedCode"] = "Valodas kods \"{0}\" ir rezervēts iebūvētajām valodām.",
                ["Loc.PromptLayoutName"] = "Izkārtojuma nosaukums",
                ["Loc.PromptPanelName"] = "Paneļa nosaukums",
                ["Loc.PromptPresetName"] = "Priekšiestatījuma nosaukums",
                ["Loc.ThemesPresetDefaultName"] = "Jauns priekšiestatījums"
            })
            {
                latvian[pair.Key] = pair.Value;
            }
        ...
        private void ApplyLanguage(string? code)
        {
            ...
            foreach (var panel in System.Windows.Application.Current?.Windows.OfType<DesktopPanel>() ??
                                  Enumerable.Empty<DesktopPanel>())
            {
                if (panel.PanelType == PanelKind.RecycleBin)
                {
                    panel.RefreshRecycleBinTitle();
                }
            }
